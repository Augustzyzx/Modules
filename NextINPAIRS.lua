...
ToggleButtonHUI.CornerRadius = UDim.new(0, 15)
...
imb.Position = UDim2.new(0.120833337, 0, 0.0952890813, 0)
imb.Size = UDim2.new(0, 40, 0, 40)
imb.Image = "rbxassetid://17788183385"
...
function library:AddWindow(text,keybind)
    ...
    btim.Position = UDim2.new(0, 0, 0, -13)
    btim.Rotation = 0
    btim.Size = UDim2.new(0, 50, 0, 50)
